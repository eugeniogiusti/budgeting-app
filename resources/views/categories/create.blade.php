...
<div class="mb-6">
    <x-common.page-breadcrumb :pageTitle="__('ui.new_category')" />
</div>

<div class="max-w-2xl">
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-800">
            <h3 class="text-base font-semibold text-gray-800 dark:text-white/90">{{ __('ui.new_category') }}</h3>
        </div>
        <div class="p-6">
                    ...
                    <div class="flex gap-3 flex-wrap">
                        @foreach(['#667eea','#4ecdc4','#f093fb','#f5a623','#43e97b','#fa709a','#4facfe','#f7971e','#a18cd1','#ff6b6b'] as $c)
                            <button type="button"
                                    ...
                                    class="color-dot w-8 h-8 rounded-full transition {{ old('color','#667eea') === $c ? 'ring-2 ring-offset-2 ring-gray-400' : '' }}"
