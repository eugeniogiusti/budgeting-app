...
<div class="max-w-lg mx-auto px-4">
    ...
    <div class="pt-12 pb-6 flex items-center gap-4">
        ...
        <h1 class="text-2xl font-bold">{{ __('ui.edit_category') }}</h1>
    </div>
                ...
                <div class="flex gap-3 flex-wrap">
                    @foreach(['#667eea','#4ecdc4','#f093fb','#f5a623','#43e97b','#fa709a','#4facfe','#f7971e','#a18cd1','#ff6b6b'] as $c)
                        <button type="button"
                                ...
                                class="color-dot w-8 h-8 rounded-full transition {{ (old('color', $category->color ?? '#667eea')) === $c ? 'ring-2 ring-offset-2 ring-gray-600' : '' }}"
