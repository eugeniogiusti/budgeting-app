...
<div class="mb-6">
    <x-common.page-breadcrumb :pageTitle="$transaction->type === 'income' ? __('ui.edit_income') : __('ui.edit_expense')" />
</div>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-800">
            <h3 class="text-base font-semibold text-gray-800 dark:text-white/90">
                {{ $transaction->type === 'income' ? __('ui.edit_income') : __('ui.edit_expense') }}
            </h3>
        </div>
        <div class="p-6">
            <form action="{{ route('transactions.update', $transaction) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="note"
                           ...
                           placeholder="{{ $transaction->type === 'income' ? __('ui.note_placeholder') : __('ui.expense_note_placeholder') }}"
                ...
                <div class="flex gap-3">
                    ...
                    <button type="submit"
                        ...
                        {{ $transaction->type === 'income' ? __('ui.save_expense') : __('ui.save_expense') }}
                    </button>
                </div>
