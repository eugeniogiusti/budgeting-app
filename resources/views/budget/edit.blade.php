...
<div class="max-w-2xl">
    ...
    <div class="grid grid-cols-2 gap-4 mb-6">
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-5 text-center">
            ...
            <div class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('ui.spent') }}</div>
        </div>
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-5 text-center">
            ...
            <div class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('ui.available') }}</div>
        </div>
    </div>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-800">
            <h3 class="text-base font-semibold text-gray-800 dark:text-white/90">{{ __('ui.assign_amount') }}</h3>
        </div>
        <div class="p-6">
